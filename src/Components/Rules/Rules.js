  ...
  return (
    <div id="Rules">
      ...
      <ul>
        ...
        <li>
          Owned: A grid is owned by the first player to make a three-in-a-row in said grid
        </li>
      ...
      <ul>
        <li>
          The player must move in the grid corresponding to the last player's move
          <ul>
            <li>
              For instance, if the previous player moved in an upper left square, the
              current player must play in the upper left grid
            </li>
          </ul>
        </li>
        <li>
          Unless no other moves are possible, a player cannot send the oponent
          to the grid they just came from
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          A player can win before all grids are owned, provided that they own more than half
          the available grids
        </li>
        <li>
          If both players own the same number of grids when all squares are filled, the
